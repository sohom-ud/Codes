...
def interpolate_v_n_P(data, species='ion'):
    ...
    max_start_time = data[f'v_{species}_1']['Epoch'][0]
    min_end_time = data[f'v_{species}_1']['Epoch'][-1]
    ...
    start_time = pd.to_datetime(max_start_time, origin='julian', unit='D')
    end_time = pd.to_datetime(min_end_time, origin='julian', unit='D')
