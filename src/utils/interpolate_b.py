...
def interpolate_b(data):
    ...
    max_start_time = data[f'b_gse_1']['Epoch'][0]
    min_end_time = data[f'b_gse_1']['Epoch'][-1]
    ...
    for probe in [1, 2, 3, 4]:
        ...
        max_start_time = max(max_start_time, data[f'b_gse_{probe}']['Epoch'][0])
        min_end_time = min(min_end_time, data[f'b_gse_{probe}']['Epoch'][-1])
