...
if __name__ == "__main__":
    ...
    interval_list = pd.read_csv(os.path.join(data_dir, 'Hubbert2022_traditional_recx_interval_list.csv'), names=['start_time', 'end_time'])
...
fail_df.to_csv(os.path.join(data_dir, 'failed_downloads_Hubbert2022.csv'))